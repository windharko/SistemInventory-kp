    ...
    <body>
        <div class="content">
            <div class='card-header py-2'>
                <h2 class="card-title text-center">Barang history</h2>
            </div>
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border-width: 1.75px;">{{$histories->created_at}}</td>
                        <td style="border-width: 1.75px;">{{$histories->name}}</td>
                        <td style="border-width: 1.75px;">{{$histories->sum}}</td>
                        <td style="border-width: 1.75px;">{{$histories->admin}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
